    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-item nav-link active" href='<c:url value="/championnat/classement2"/>'><strong>Classement</strong></a>
                <a class="nav-item nav-link" href='<c:url value="/championnat/matchsattente" />'>Matchs en attente</a>
...
-->
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-item nav-link active" href='#classement'><strong>Classement</strong></a>
                <a class="nav-item nav-link" href='#attente'>Matchs en attente</a>
                <a class="nav-item nav-link" href='#termines'>Matchs termines</a>
                <a class="nav-item nav-link" href='#stats'>Stats des joueurs</a>
            </div>
        </div>
    </nav>

    <!-- Classement -->
    <h2 id="classement" style="text-align:center;"><b>Classement </b></h2>
    ...
    <!-- Match en Attente -->
    <h2 id="attente" style="text-align:center;">Matchs <b>En Attente</b></h2>
    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid"
           aria-describedby="example1_info">
        <thead>
        <tr role="row">
    ...
    <!-- Match terminés -->
    <h2 id="termines" style="text-align:center;">Matchs <b>Termines</b></h2>
    ...
    <!-- Stats des joueurs  -->
    <h2 id="stats" style="text-align:center;">Les <b>Stats de joueurs</b></h2>
