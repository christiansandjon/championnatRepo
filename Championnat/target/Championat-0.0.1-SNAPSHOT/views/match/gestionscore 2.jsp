...
<h2 style="text-align:center;">${match.championat.nom}  <b>${match.equipe1.nom} </b>vs <b>${match.equipe2.nom}</b> </h2>
 <c:if test="${error==1 }">
...
<a class="btn btn-primary" href='<c:url value="/championat/classement?id=${match.championat.id}" />'> < Retour aux classements </a>
...
<table id="example2" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                  <thead>
                  <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="">${match.equipe1.nom}</th><th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="">${match.equipe2.nom}</th></tr>
                  </thead>
                  <tbody>
...
<table id="example2" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                  <thead>
                  <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="">Minute</th><th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="">Nom joueur</th><th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="">Equipe</th><th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="">Nombre</th><th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="">Action</th></tr>
                  </thead>
                  <tbody>
...
<table id="example2" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                  <thead>
                  <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="">Nom joueur</th><th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="">Equipe</th><th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="">Type carton</th><th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="">Action</th></tr>
                  </thead>
                  <tbody>
...
<form method="POST" action='<c:url value="/match/save-but" />' >
    ...
    <div class="col-sm-10">
    <input value="" name="nombrebut" min='0' max='1' type="number" class="form-control" id="inputAddress" placeholder="But" required>
    ...
    <div class="col-sm-10">
    <input value="" name="minute" min='0' max='125' type="number" class="form-control" id="inputAddress" placeholder="Minute" required>
